...
#horProgressToastHost{position:fixed;right:14px;top:14px;z-index:2147483647;pointer-events:none;width:min(390px,calc(100vw - 28px));font-family:system-ui,-apple-system,Segoe UI,sans-serif;display:flex;flex-direction:column;gap:10px}
...
function setMode(v){v=v==='local'?'local':'preview';localStorage.setItem(MODE_KEY,v);applyMode();try{if(typeof window.horCareerModeChanged==='function')window.horCareerModeChanged(v);}catch(e){}return v;}
