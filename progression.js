...
function refreshCareerStateControls(){
  ...
  if(horOnBtn){
    horOnBtn.textContent=live?'✓ Local Careers ON':'Turn On Local Careers';
...
P.localCareer={mode,setMode,applyMode,previewActivation,activateLocal,deactivateLocal,syncFromLifetime,recordRelationships,relationshipRead,publicProfile,botPublicProfile,showCareerCard,showCareerGuide,restoreCareerFromRecoveryCode,showActivationPanel};
applyMode();
})();
